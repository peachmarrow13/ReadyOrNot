...
class UAIAction_NonCompliant_DLC2_C final : public UAIAction
{
public:
	...
	double                                        TimeOfLastMoveCalc;                                // 0x00A0(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	double                                        DynamicRadius;                                     // 0x00A8(0x0008)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
public:
	...
	{
		BP_STATIC_CLASS_IMPL("AIAction_NonCompliant_DLC2_C")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"AIAction_NonCompliant_DLC2_C")
	}
	static class UAIAction_NonCompliant_DLC2_C* GetDefaultObj()
	{
		return GetDefaultObjImpl<UAIAction_NonCompliant_DLC2_C>();
	}
};
DUMPER7_ASSERTS_UAIAction_NonCompliant_DLC2_C;
