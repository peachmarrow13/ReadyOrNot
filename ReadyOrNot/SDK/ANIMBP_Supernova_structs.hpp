...
struct ANIMBP_Supernova::FAnimBlueprintGeneratedConstantData final : public FAnimBlueprintConstantData
{
public:
...
DUMPER7_ASSERTS_ANIMBP_Supernova__FAnimBlueprintGeneratedConstantData;

// ScriptStruct ANIMBP_Supernova.ANIMBP_Supernova_C.AnimBlueprintGeneratedMutableData
// 0x0001 (0x0002 - 0x0001)
struct ANIMBP_Supernova::FAnimBlueprintGeneratedMutableData final : public FAnimBlueprintMutableData
{
public:
	bool                                          __BoolProperty;                                    // 0x0001(0x0001)(BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
};
DUMPER7_ASSERTS_ANIMBP_Supernova__FAnimBlueprintGeneratedMutableData;
