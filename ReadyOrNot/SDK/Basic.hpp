...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08A4B3B0;
	constexpr int32 AppendString      = 0x00C8E8B0;
	constexpr int32 GNames            = 0x089A5000;
	constexpr int32 GWorld            = 0x08BB7F58;
	constexpr int32 ProcessEvent      = 0x00E47810;
