...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08C26570;
	constexpr int32 AppendString      = 0x00C98400;
	constexpr int32 GNames            = 0x08B24CB8;
	constexpr int32 GWorld            = 0x08D94888;
	constexpr int32 ProcessEvent      = 0x00E535C0;
