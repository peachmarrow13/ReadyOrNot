...
void UTextBlock::SetCharacterLimit(int32 InCharacterLimit)
{
	...
	Params::TextBlock_SetCharacterLimit Parms{};
...
// (Final, RequiredAPI, Native, Public, BlueprintCallable)
// Parameters:
// const class FString&                    InTruncationCharacters                                 (Parm, ZeroConstructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
void UTextBlock::SetTruncationCharacters(const class FString& InTruncationCharacters)
{
	...
	Params::TextBlock_SetTruncationCharacters Parms{};
...
int32 UTextBlock::GetCharacterLimit() const
{
	static class UFunction* Func = nullptr;
	...
	Params::TextBlock_GetCharacterLimit Parms{};
...
class FString UTextBlock::GetTruncationCharacters() const
{
	static class UFunction* Func = nullptr;
	...
	Params::TextBlock_GetTruncationCharacters Parms{};
