...
{
public:
	struct FLinearColor                           JoyColor;                                          // 0x0188(0x0010)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	TMulticastInlineDelegate<void(const struct FLinearColor& NewColor)> OnColorChanged;              // 0x0198(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
public:
	...
	{
		STATIC_CLASS_IMPL("RamaColorPicker")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"RamaColorPicker")
	}
...
DUMPER7_ASSERTS_URamaColorPicker;
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("RamaVictoryPluginCreateProcessPipe")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"RamaVictoryPluginCreateProcessPipe")
	}
...
DUMPER7_ASSERTS_URamaVictoryPluginCreateProcessPipe;
...
public:
	...
	static void VictoryFloatMinusEquals(float& float_0, float Sub, float* FloatOut);
	static void VictoryFloatPlusEquals(float& float_0, float Add, float* FloatOut);
	...
	static void VictoryIntMinusEquals(int32& int_0, int32 Sub, int32* IntOut);
	static void VictoryIntPlusEquals(int32& int_0, int32 Add, int32* IntOut);
...
public:
	static class UClass* StaticClass()
	{
		STATIC_CLASS_IMPL("VictoryBPFunctionLibrary")
	}
	static const class FName& StaticName()
	{
		STATIC_NAME_IMPL(L"VictoryBPFunctionLibrary")
	}
...
DUMPER7_ASSERTS_UVictoryBPFunctionLibrary;
