...
public:
	...
	class FString                                 CallFunc_GetLoadingScreenDetails_OutMap;           // 0x0008(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetLoadingScreenDetails_OutMode;          // 0x0018(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	class FString                                 CallFunc_GetLoadingScreenDetails_OutSessionName;   // 0x0028(0x0010)(ZeroConstructor, HasGetValueTypeHash)
	...
	bool                                          CallFunc_EqualEqual_StrStr_ReturnValue_1;          // 0x003A(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	uint8                                         Pad_3B[0x5];                                       // 0x003B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	class FText                                   CallFunc_GetLoadingProgressText_ReturnValue;       // 0x0040(0x0018)()
	...
	bool                                          CallFunc_IsConsole_ReturnValue;                    // 0x00AC(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_ShouldShowLoadingPercentage_ReturnValue;  // 0x00AD(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          CallFunc_IsCMBOperational_ReturnValue;             // 0x00AE(0x0001)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
